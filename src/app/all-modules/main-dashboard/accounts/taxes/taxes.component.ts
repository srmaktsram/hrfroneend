...
export class TaxesComponent implements OnInit, OnDestroy {
  ...
  getTaxes() {
    this.http
      .get(
        "http://localhost:8443/admin/taxes/adminGetTaxes" + "/" + this.adminId
      )
      .subscribe((data: any) => {
  ...
  addTaxSubmit() {
    ...
    if (this.addTaxes.valid) {
      ...
      this.http
        .post("http://localhost:8443/admin/taxes/createTaxes", obj)
        .subscribe((data: any) => {
  ...
  updateStatus(val, id) {
    this.http
      .patch("http://localhost:8443/admin/taxes/updateTaxes" + "/" + id, {
        status: val,
      })
      .subscribe((data: any) => {
        console.log(data);
  ...
  editTaxSubmit() {
    ...
    this.http
      .patch(
        "http://localhost:8443/admin/taxes/updateTaxes" + "/" + this.editId,
        obj
      )
      .subscribe((data1: any) => {
  ...
  deleteTaxes() {
    this.http
      .patch(
        "http://localhost:8443/admin/taxes/deleteTaxes" + "/" + this.tempId,
        {}
      )
      .subscribe((data: any) => {
