...
export class ProvidentFundComponent implements OnInit, OnDestroy {
  ...
  getProvidentfund() {
    this.http
      .get(
        "http://localhost:8443/admin/provident/adminGetProvident" +
          "/" +
          this.adminId
      )
      .subscribe((data: any) => {
  ...
  updateStatus(val, id) {
    this.http
      .patch(
        "http://localhost:8443/admin/provident/updateProvident" + "/" + id,
        { status: val }
      )
      .subscribe((data1: any) => {
        console.log(data1);
  ...
  addProvident() {
    ...
    if (this.addProvidentfund.valid) {
      ...
      this.http
        .post("http://localhost:8443/admin/provident/createProvident", obj)
        .subscribe((data: any) => {
  ...
  editProvident() {
    ...
    this.http
      .patch(
        "http://localhost:8443/admin/provident/updateProvident" +
          "/" +
          this.editId,
        obj
      )
  ...
  deleteProvident() {
    this.http
      .patch(
        "http://localhost:8443/admin/provident/deleteProvident" +
          "/" +
          this.tempId,
        {}
      )
